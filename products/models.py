...
class MainCategory(models.Model):
    ...
    slug = models.SlugField(
        ...
        unique=True,
        blank=False,
        verbose_name="Main Category slug",
        help_text="format: required, max_length=150",
    )
...
class Category(models.Model):
    ...
    main_category = models.ForeignKey(
        MainCategory, on_delete=models.CASCADE, verbose_name="main category title"
    )
    name = models.CharField(
        max_length=100,
        null=False,
...
class Subcategory(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, verbose_name="category title"
    )
    name = models.CharField(
        max_length=100,
        null=False,
...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(
        Subcategory, on_delete=models.CASCADE, verbose_name="subcategory title"
    )
